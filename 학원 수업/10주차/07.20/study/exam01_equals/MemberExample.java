...
public class MemberExample {
	...
	public static void main(String[] args) {
		...
		//재정의 된 equals 사용
		if(obj1.equals(obj2)) {	// obj1와 obj2 객체를 비교 (단, 참조타입이여서 equals 메서드를 써서 비교)
			//기본 타입끼리 비교할 때에는 == 사용
			System.out.println("obj1 obj2같음.");
		} else {
		...
		//obj3 라는 변수명(선언부분)에 obj2의 실제값을 대입(주소 연결)
		//기존, obj3에 할당된 인스턴스 대신에 obj2의 인스턴스가 연결되어서
		//원래 있던 obj3에 할당된 인스턴스는 연결 끊어짐 (가비지 컬렉터가 찾아서 회수)
		obj3 = obj2;
		if(obj2.equals(obj3)) {	//같은 인스턴스 주소를 가르키기 떄문에
			//인스턴스가 같다고 보고, if문의 True값이나옴
